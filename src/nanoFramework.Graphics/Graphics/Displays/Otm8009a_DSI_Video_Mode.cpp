...
bool DisplayDriver::Initialize()
{
    ...
    g_DisplayInterface
        .SendCommand(15, 0xCE, 0x18, 0x04, 0x03, 0x39, 0x00, 0x00, 0x00, 0x18, 0x03, 0x03, 0x3A, 0x00, 0x00, 0x00);

    g_DisplayInterface.SendCommand(2, 0x00, 0xB0);
    g_DisplayInterface
        .SendCommand(15, 0xCE, 0x18, 0x02, 0x03, 0x3B, 0x00, 0x00, 0x00, 0x18, 0x01, 0x03, 0x3C, 0x00, 0x00, 0x00);
    ...
    // Setup to default Orientation(Landscape)
    //___________________
    SetDefaultOrientation();

    g_DisplayInterface.SendCommand(5, CASET, 0x00, 0x00, (LCD_X_SIZE - 1) >> 8, (LCD_X_SIZE - 1) & 0xff);
    g_DisplayInterface.SendCommand(5, PASET, 0x00, 0x00, (LCD_Y_SIZE - 1) >> 8, (LCD_Y_SIZE - 1) & 0xff);
...
void DisplayDriver::SetupDisplayAttributes()
{
    ...
    Attributes.LongerSide = LCD_X_SIZE;
    Attributes.ShorterSide = LCD_Y_SIZE;
