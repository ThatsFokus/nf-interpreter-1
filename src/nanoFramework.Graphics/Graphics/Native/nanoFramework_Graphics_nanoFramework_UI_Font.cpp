...
HRESULT Library_nanoFramework_Graphics_nanoFramework_UI_Font::ComputeExtent___VOID__STRING__BYREF_I4__BYREF_I4__I4(
    CLR_RT_StackFrame &stack)
{
    ...
    hbHeight.SetInteger((CLR_INT32)font->m_font.m_metrics.m_height);
    NANOCLR_CHECK_HRESULT(hbHeight.StoreToReference(pArgs[2], 0));

    NANOCLR_NOCLEANUP();
}

HRESULT Library_nanoFramework_Graphics_nanoFramework_UI_Font::
    ComputeTextInRect___VOID__STRING__BYREF_I4__BYREF_I4__I4__I4__I4__I4__U4(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
    CLR_GFX_Font *font;
    CLR_RT_HeapBlock *pArgs;
    ...
    hbWidth.SetInteger((CLR_INT32)renderWidth);
    NANOCLR_CHECK_HRESULT(hbWidth.StoreToReference(pArgs[1], 0));
    hbHeight.SetInteger((CLR_INT32)renderHeight);
    NANOCLR_CHECK_HRESULT(hbHeight.StoreToReference(pArgs[2], 0));
