...
__nfweak bool DeviceBlockInfo_FindRegionFromAddress(
    DeviceBlockInfo *blockInfo,
    ByteAddress address,
...
__nfweak bool DeviceBlockInfo_FindNextUsageBlock(
    DeviceBlockInfo *blockInfo,
...
__nfweak bool DeviceBlockInfo_FindForBlockUsage(
    DeviceBlockInfo *blockInfo,
    unsigned int blockUsage,
    unsigned int *address,
    unsigned int *blockRegionIndex,
...
__nfweak bool BlockStorageStream_InitializeWithBlockStorageDevice(
...
__nfweak bool BlockStorageDevice_Read(
...
__nfweak bool BlockStorageDevice_Write(
    BlockStorageDevice *device,
    unsigned int address,
    unsigned int numBytes,
    unsigned char *pSectorBuf,
    bool readModifyWrite)
{
    return false;
}

__nfweak bool BlockStorageDevice_Memset(
    BlockStorageDevice *device,
    unsigned int address,
    unsigned char data,
    unsigned int NumBytes)
...
__nfweak bool BlockStorageDevice_FindRegionFromAddress(
    BlockStorageDevice *device,
    unsigned int address,
    unsigned int *blockRegionIndex,
    unsigned int *blockRangeIndex)
...
__nfweak bool BlockStorageDevice_FindForBlockUsage(
    BlockStorageDevice *device,
    unsigned int blockUsage,
    unsigned int *address,
    unsigned int *blockRegionIndex,
...
__nfweak bool BlockStorageDevice_FindNextUsageBlock(
    BlockStorageDevice *device,
    unsigned int blockUsage,
    unsigned int *address,
    unsigned int *blockRegionIndex,
