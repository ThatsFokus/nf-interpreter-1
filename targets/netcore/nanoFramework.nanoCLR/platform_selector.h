...
#define PLATFORM_DEPENDENT_USB_QUEUE_PACKET_COUNT                                                                      \
    2 // there is one queue for each pipe of each endpoint and the size of a single packet is sizeof(USB_PACKET64) == 68
      // bytes
